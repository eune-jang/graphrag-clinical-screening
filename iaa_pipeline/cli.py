...
Bundled inputs live at `streamlit_apps/data/{trial_id}/stage1/input.json`
(30 NSCLC trials, generated by `scripts/convert_production_to_iaa.py`).

Examples:
    # Run Stage 1 on KEYNOTE-671 (NCT03425643) with caching
